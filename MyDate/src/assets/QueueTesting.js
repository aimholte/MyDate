let myMessage =[
  ...
  },
  {
    ...
    "scope" : "GOOGLE",
    "reference" : "CoQBeQAAAFvf12y8veSQMdIMmAXQmus1zqkgKQ-O2KEX0Kr47rIRTy6HNsyosVl0CjvEBulIu_cujrSOgICdcxNioFDHtAxXBhqeR-8xXtm52Bp0lVwnO3LzLFY3jeo8WrsyIwNE1kQlGuWA4xklpOknHJuRXSQJVheRlYijOHSgsBQ35mOcEhC5IpbpqCMe82yR136087wZGhSziPEbooYkHLn9e5njOTuBprcfVw",
    "types" : [ "travel_agency", "establishment" ],
    "vicinity" : "32 The Promenade, King Street Wharf 5, Sydney"
  },
  {
    "geometry" : {
  ...
  },
  {
    ...
    "icon" : "http://maps.gstatic.com/mapfiles/place_api/icons/travel_agent-71.png",
    "id" : "a97f9fb468bcd26b68a23072a55af82d4b325e0d",
    "name" : "Antony Jennison's Massage House",
    "opening_hours" : {
      "open_now" : true
    },
    "photos" : [
  ...
  },
  {
    ...
    "icon" : "http://maps.gstatic.com/mapfiles/place_api/icons/travel_agent-71.png",
    "id" : "a97f9fb468bcd26b68a23072a55af82d4b325e0d",
    "name" : "A litera; ton of string cheese",
    "opening_hours" : {
      "open_now" : true
    },
    "photos" : [
...
function initial() {
  meal1=Mealqueue.shift();
  meal2=Mealqueue.shift();
  meal3=Mealqueue.shift();
  place1=Placequeue.shift();
  place2=Placequeue.shift();
  place3=Placequeue.shift();
  place4=Placequeue.shift();
  place5=Placequeue.shift();
  place6=Placequeue.shift();
...
function trader(location, queue) {
  queue.push(location);
  let newPlace=queue.shift();
  if (newPlace.showed=="false"){
    newPlace.showed="true";
  }
  else {
    /*Add a output messsage to notify that they are at end of queue*/
  }
  return newPlace;
}
